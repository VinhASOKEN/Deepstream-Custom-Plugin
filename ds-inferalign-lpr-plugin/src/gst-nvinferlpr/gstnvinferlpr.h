...
#ifndef __GST_NVINFERLPR_H__
#define __GST_NVINFERLPR_H__
...
typedef struct _GstNvInferLpr GstNvInferLpr;
typedef struct _GstNvInferLprClass GstNvInferLprClass;
typedef struct _GstNvInferLprImpl GstNvInferLprImpl;

/* Standard GStreamer boilerplate */
#define GST_TYPE_NVINFERLPR (gst_nvinferlpr_get_type())
#define GST_NVINFERLPR(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_NVINFERLPR,GstNvInferLpr))
#define GST_NVINFERLPR_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_NVINFERLPR,GstNvInferLprClass))
#define GST_NVINFERLPR_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), GST_TYPE_NVINFERLPR, GstNvInferLprClass))
#define GST_IS_NVINFERLPR(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_NVINFERLPR))
#define GST_IS_NVINFERLPR_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_NVINFERLPR))
#define GST_NVINFERLPR_CAST(obj)  ((GstNvInferLpr *)(obj))
...
extern guint gst_nvinferlpr_signals[LAST_SIGNAL];
...
} GstNvInferLprDetectionFilterParams;
...
} GstNvInferLprColorParams;

/** Holds the cached information of an object. */
struct GstNvInferLprObjectInfo {
  /** Vector of cached classification attributes. */
  std::vector<NvDsInferAttribute> attributes;
  /** Cached string label. */
  std::string label;

  GstNvInferLprObjectInfo(const GstNvInferLprObjectInfo&) = delete;
  GstNvInferLprObjectInfo() = default;
  ~GstNvInferLprObjectInfo(){
 ...
 * tracking id.
 */
typedef struct _GstNvInferLprObjectHistory
{
  ...
  GstNvInferLprObjectInfo cached_info;
} GstNvInferLprObjectHistory;

/** Map type for maintaing inference history for objects based on their tracking ids.*/
typedef std::unordered_map<guint64, std::shared_ptr<GstNvInferLprObjectHistory>> GstNvInferLprObjectHistoryMap;
...
typedef struct
{
  ...
  GstNvInferLprObjectHistoryMap object_history_map;
...
} GstNvInferLprSourceInfo;

/**
 * GstNvInferLpr element structure.
 */
struct _GstNvInferLpr
{
  ...
  /** Path to the configuration file for this instance of gst-nvinferlpr. */
  ...
  std::vector<GstNvInferLprDetectionFilterParams> *perClassDetectionFilterParams;

  /** Vector for per-class color parameters. */
  std::vector<GstNvInferLprColorParams> *perClassColorParams;
  ...
  std::unordered_map<gint, GstNvInferLprSourceInfo> *source_info;
  ...
  /** PTS of input buffer when nvinferlpr last posted the warning about untracked
   * object. */
  ...
  GstNvInferLprImpl *impl;

  gint alignment_type;
};

/* GStreamer boilerplate. */
struct _GstNvInferLprClass {
  ...
  /** signal : model-update
    ...
    */
  void (*model_updated) (GstNvInferLpr *, gint err, const gchar *cfg_file);
};

GType gst_nvinferlpr_get_type (void);

G_END_DECLS

#endif /* __GST_INFERLPR_H__ */
