...
#ifndef __GSTNVINFERLPRALLOCATOR_H__
#define __GSTNVINFERLPRALLOCATOR_H__
...
/**
 * Get GstNvInferLprMemory structure associated with buffer allocated using
 * GstNvInferLprAllocator.
 *
 * @param buffer GstBuffer allocated by this allocator.
 *
 * @return Pointer to the associated GstNvInferLprMemory structure
 */
GstNvInferLprMemory *gst_nvinferlpr_buffer_get_memory (GstBuffer * buffer);

/**
 * Create a new GstNvInferLprAllocator with the given parameters.
 *
 ...
 *
 * @return Pointer to the GstNvInferLprAllocator structure cast as GstAllocator
 */
GstAllocator *gst_nvinferlpr_allocator_new (guint width, guint height,
