...
#ifndef __GST_NVINFERLPR_PROPERTY_PARSER_H__
#define __GST_NVINFERLPR_PROPERTY_PARSER_H__
...
gboolean gst_nvinferlpr_parse_config_file (GstNvInferLpr *nvinferlpr,
        NvDsInferContextInitParams *init_params, const gchar * cfg_file_path);

gboolean gst_nvinferlpr_parse_context_params (NvDsInferContextInitParams *params,
        const gchar * cfg_file_path);


#endif /*__GST_NVINFERLPR_PROPERTY_PARSER_H__*/
